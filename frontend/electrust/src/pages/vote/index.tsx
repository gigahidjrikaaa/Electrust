            ...
            <div className="bg-oxfordBlue w-full">
                <div className="h-fit min-h-screen flex flex-col justify-center items-center text-justify mt-20 pt-10">
                    ...
                    <div className="flex flex-row justify-center items-center h-full">
                        <CandidateCard name="Choice 1" image="/cand1.jpg" voteID={"1231234123scadafjojaso123e"}/>
                        <CandidateCard name="Choice 2" image="/fotokrisna.jpg" voteID={"8381r1irh8f9w149fjidhh018fh1"} />
                        <CandidateCard name="Choice 3" image="/cand10.jpg" voteID={"213412nwj23124inwln1i2lnaf"} />
